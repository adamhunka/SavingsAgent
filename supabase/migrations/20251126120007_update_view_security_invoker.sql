-- ============================================================================
-- Migration: Update View Security Invoker
-- Description: Adds security_invoker = true to v_active_products view
...
comment on view public.v_active_products is 'Active, verified products from currently valid flyers with all related information. Uses security_invoker to enforce querying user RLS policies.';
